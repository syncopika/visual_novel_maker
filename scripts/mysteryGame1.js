...
Routes["mainRoute"] = [
	...
	SetScene.dialog("", "when I was startled by several rather large knocks upon my front door."),
	SetScene.dialog("", "mind you, it was a quarter before 9 o'clock and I was not to be expecting guests."),
	SetScene.dialog("", "'Perhaps it is the constable?,' I thought, for a string of petty crimes had been committed lately."),
	SetScene.dialog("", "Anyhow, I hurried to the door."),
	SetScene.background("artAssets/stairs.png"),
	SetScene.dialog("", "The knocking persisted as I went down the stairs, and as I got to the door."),
